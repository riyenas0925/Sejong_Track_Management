                        ...
                        <div class="col-xs-12">
                            <div class="box-body">
                                ...
                                <div class="fileDrop" style="cursor:pointer">
                                    ...
                                    <label for="file" id="uploadText"><img src="../dist/img/파일선택.png"
                                                                           width="100px;"></label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <div style="height: 528px; overflow:auto">
                            ...
                            본 일반 사용 약관("일반 약관")은 해당하는 추가 약관(아래 1.2조 참조)과 구독 및 취소 약관(통칭하여 "약관")과 함께 본사 웹사이트, 고객 지원 및
                            Creative Cloud와 같은 서비스(통칭하여 "서비스")의 사용 및 서비스의 일부로 본사가 포함하는 소프트웨어, 모든 응용 프로그램, 샘플 파일 및 컨텐츠
                            파일(아래 정의), 스크립트, 소스 코드, 지침 세트 및 관련 설명서(통칭하여 "소프트웨어")의 사용에 적용됩니다. 귀하가 특정 서비스 또는 소프트웨어와 관련하여
                            본사와 다른 계약을 맺은 경우, 해당 계약이 본 약관과 상충할 때 해당 계약의 조항이 우선합니다. 아래의 4조에서 추가적으로 논의되는 바와 같이, 귀하는 귀하의
                            컨텐츠에서 귀하가 갖는 모든 권리 및 소유권을 유지합니다.<br><br>
                            개인 Adobe ID로 등록하려면 만13세 이상이어야 합니다.초등 및 중등 교육 명명 사용자 상품에 참여하는 학교는 만13세 미만 아동에게 엔터프라이즈 수준의
                            Adobe ID를 발생할 수 있지만 이는 명시적인 부모 동의를 받은 후에 이루어져야 합니다.<br>
                        </div>
                    </div>
